...
export class ScoringEngine {
  ...
  static async scoreResponse(
    ...
    await db
      ...
      .set({
        score: result.score.toString() as any,
  ...
  static async createPlacementResult(
    ...
    await db.insert(placementResults).values({
      userId,
      attemptId,
      readingScore: domainScoresMap.get('reading')?.toString() as any || null,
      writingScore: domainScoresMap.get('writing')?.toString() as any || null,
      listeningScore: domainScoresMap.get('listening')?.toString() as any || null,
      speakingScore: domainScoresMap.get('speaking')?.toString() as any || null,
      grammarScore: domainScoresMap.get('grammar')?.toString() as any || null,
      vocabularyScore: domainScoresMap.get('vocabulary')?.toString() as any || null,
      overallScore: overallScore.percentage.toString() as any,
      recommendedLevel,
    });
