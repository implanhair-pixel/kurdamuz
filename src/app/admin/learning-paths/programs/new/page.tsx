...
export default async function NewProgramPage() {
  ...
  async function createProgramAction(formData: FormData) {
    ...
    const data = {
      ...
      programType: formData.get('programType') as 'beginner' | 'intermediate' | 'advanced' | 'specialized',
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <form action={createProgramAction as any} className="bg-white rounded-lg shadow-md p-8 border border-gray-200">
