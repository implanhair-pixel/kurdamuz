...
import { BookOpen, Play, Clock, Star, ChevronRight, Zap, Users, Lock, CheckCircle } from 'lucide-react';
...
export default function CoursesPage({ params }: { params: Promise<{ locale: string }> }) {
      ...
      <div className="bg-[#0d1f38] border-b border-white/6">
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/en" className="text-sm text-slate-400 hover:text-white transition-colors">Home</Link>
            <Link href="/en/courses" className="text-sm text-emerald-400 font-semibold">Courses</Link>
            <Link href="/en/dashboard" className="text-sm font-bold bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-4 py-2 rounded-xl">Dashboard</Link>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-14 pb-10">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            All <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-300">Courses</span>
          </h1>
          <p className="text-slate-400 max-w-xl mx-auto">
            From absolute beginner to advanced fluency. Every course is structured for maximum retention and real-world application.
          </p>
        </div>
          ...
          {courses.map((course: any) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* Button */}
                <button className={`w-full py-2.5 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2 ${
                  course.locked
